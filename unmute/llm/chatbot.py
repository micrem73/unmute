...
from unmute.llm.system_prompt import ConstantInstructions, Instructions, BAMBOLA_INSTRUCTIONS
...
class Chatbot:
    def __init__(self):
        # Usa il profilo bambola come system prompt di default
        self.chat_history: list[dict[Any, Any]] = [
            {"role": "system", "content": BAMBOLA_INSTRUCTIONS}
        ]
